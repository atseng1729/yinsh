...
var $author$project$Constants$None = {$: 'None'};
...
var $author$project$Constants$vertices = _List_fromArray(
	[
		_Utils_Tuple2(-5, -4),
		_Utils_Tuple2(-5, -3),
		_Utils_Tuple2(-5, -2),
...
var $author$project$Constants$emptyBoard = $elm$core$Dict$fromList(
	A2(
		$elm$core$List$map,
		function (v) {
...
var $author$project$Yinsh$init = function (flags) {
...
var $author$project$Constants$edges_coords = A2(
	...
	function (_v0) {
		...
		var p2 = _v0.b;
		return _Utils_Tuple2(
			$author$project$Constants$hex2pix(p1),
...
var $author$project$Yinsh$renderPieces = function (boardData) {
	return $timjs$elm_collage$Collage$group(
		A2(
			$elm$core$List$map,
			$author$project$Yinsh$renderPiece,
			A2(
				$elm$core$List$filter,
				function (_v0) {
					var p = _v0.a;
